...
async function checkForNewDonations(donations, currentTime) {
  const previousTime = moment(currentTime).subtract(17, "days").toDate(); // this defines the window in which a donation is considered 'new'. Previous time is 5:30 yesterday
